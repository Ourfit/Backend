package io.ourfit.api.global.web.sse.impl;

import io.ourfit.api.global.web.sse.SseService;
import io.ourfit.api.global.web.sse.SseType;
...
public class SseServiceImpl implements SseService, DisposableBean {
  ...
  @Override
  public void destroy() {
    this.emitterMap.values().forEach(SseEmitter::complete);

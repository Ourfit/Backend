...
public class JwtAuthenticationToken extends AbstractAuthenticationToken {
  ...
  private final OurfitUserDetails principal;
   ...
   *
   * @param principal 인증된 사용자의 {@link OurfitUserDetails} 정보
   */
  private JwtAuthenticationToken(OurfitUserDetails principal) {
   ...
   */
  public static JwtAuthenticationToken authenticated(@NotNull OurfitUserDetails userDetails) {
